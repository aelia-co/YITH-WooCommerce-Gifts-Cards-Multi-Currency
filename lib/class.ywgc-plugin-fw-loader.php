		...
		public function register_pointer() {
			...
			$args[] = array(
				...
				'content'    => sprintf( '<h3> %s </h3> <p> %s </p>',
					...
					__( 'In YIT Plugins tab you can find YITH WooCommerce Gift Cards options.<br> From this menu you can access all settings of YITH plugins activated.', 'yith-woocommerce-gift-cards' ) . '<br>' . $premium_message
				),
